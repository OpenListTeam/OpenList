...
type Addition struct {
	...
	UploadToken    string `json:"upload_token" required:"false" help:"token header value for the file API, obtained from Rakuten Drive web app request headers; leave empty if not required"`
