...
func (d *ThunderBrowser) RapidHashAlgos() []*utils.HashType {
	return []*utils.HashType{hash_extend.GCID}
}

// RapidHashNeedsPieces 迅雷浏览器不需要分片哈希
func (d *ThunderBrowser) RapidHashNeedsPieces() bool {
	return false
}

// RapidUploadByHashes 使用种子中的GCID哈希尝试秒传
func (d *ThunderBrowser) RapidUploadByHashes(ctx context.Context, dstDir model.Obj, req *driver.SeedRapidUploadRequest, overwrite bool) (model.Obj, error) {
